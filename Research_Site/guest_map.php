            ...
            $.ajax({
                ...
                success: function(data){	
                    ...
                    if(submit_msg.status=="true"){
                        $('#header').load('guest_map.php #header');
                        $('#toppanel').load('guest_map.php #toppanel');
                        //$("#open").html('Log Out');
                        setTimeout(function(){
                            $("#log_user").val("");
                            $("#pwd_user").val("");
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    if(isset($_POST['send_details_user_submit'])){
        ...
        if($mail_sucess){
            echo("<script>window.alert('We have sent the username and password to given email..');location.href = 'guest_map.php';</script>");
        }
    }
		...
		<div class="content clearfix">
			<div class="left">
                ...
                <div id="sign_box_admin" style="margin-top: 5px;">
                    <form method="post" action="guest_map.php" name="send_details_admin" id="send_details_admin" >
...
<!--					<a class="lost-pwd" href="#">Lost your password?</a>-->
                    ...
                    <div id="sign_box_user" style="margin-top: 5px;">
                        <form method="post" action="guest_map.php" name="send_details_user" id="send_details_user" >
                            <label style="color: black">Email
	...
	<div id="header">
		<div>
			...
			<ul>
				...
				<li class="current"><a href="guest_map.php">Map</a></li>
	...
	<div id="header">
		<div>
			...
			<ul>
				...
				<li><a href="services.php">Services</a></li>
				<li><a href="gallery.php">Gallery</a></li>
				<li class="current"><a href="guest_map.php">Guest Map</a></li>
				<li><a href="guestbook.php">GuestBook</a></li>
				<li><a href="contact.php">Contact</a></li>
			</ul>
		</div>
...
<?php } ?>
	<div id="body">
		...
		<div id="content" align="center">
					...
					<iframe src="gps/test1.html" width="850px" height="800px" align="middle" scrolling="no" frameborder="0"></iframe>
