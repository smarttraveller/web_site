            ...
            $.ajax({
                ...
                success: function(data){	
                    ...
                    if(submit_msg.status=="true"){
                        $('#header').load('guestbook.php #header');
                        $('#toppanel').load('guestbook.php #toppanel');
                        //$("#open").html('Log Out');
                        setTimeout(function(){
                            $("#log_user").val("");
                            $("#pwd_user").val("");
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    if(isset($_POST['send_details_user_submit'])){
        ...
        if($mail_sucess){
            echo("<script>window.alert('We have sent the username and password to given email..');location.href = 'guestbook.php';</script>");
        }
    }
		...
		<div class="content clearfix">
			<div class="left">
                ...
                <div id="sign_box_admin" style="margin-top: 5px;">
                    <form method="post" action="guestbook.php" name="send_details_admin" id="send_details_admin" >
...
<!--					<a class="lost-pwd" href="#">Lost your password?</a>-->
                    ...
                    <div id="sign_box_user" style="margin-top: 5px;">
                        <form method="post" action="guestbook.php" name="send_details_user" id="send_details_user" >
                            <label style="color: black">Email
	...
	<div id="header">
		<div>
			...
			<ul>
				...
				<li class="current"><a href="guestbook.php">GuestBook</a></li>
...
<?php } ?>
	<div id="body">
		...
		<div id="content" align="center">
					...
					<iframe src="guestbook/index.php" width="635px" height="650px" align="middle"></iframe>
