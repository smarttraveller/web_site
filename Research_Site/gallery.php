            ...
            $.ajax({
                ...
                success: function(data){	
                    ...
                    if(submit_msg.status=="true"){
                        $('#header').load('gallery.php #header');
                        $('#toppanel').load('gallery.php #toppanel');
                        //$("#open").html('Log Out');
                        setTimeout(function(){
                            $("#log_user").val("");
                            $("#pwd_user").val("");
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    if(isset($_POST['send_details_user_submit'])){
        ...
        if($mail_sucess){
            echo("<script>window.alert('We have sent the username and password to given email..');location.href = 'gallery.php';</script>");
        }
    }
		...
		<div class="content clearfix">
			<div class="left">
                ...
                <div id="sign_box_admin" style="margin-top: 5px;">
                    <form method="post" action="gallery.php" name="send_details_admin" id="send_details_admin" >
...
<!--					<a class="lost-pwd" href="#">Lost your password?</a>-->
                    ...
                    <div id="sign_box_user" style="margin-top: 5px;">
                        <form method="post" action="gallery.php" name="send_details_user" id="send_details_user" >
                            <label style="color: black">Email
...
<?php } ?>
	<div id="body">
		<div id="content">
			<div id="about">
			  <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="600">
				  ...
				  <!--[if !IE]>-->
				  <object type="application/x-shockwave-flash" data="gallery/gallery.swf" width="920" height="600">
				    <!--<![endif]-->
				    <param name="quality" value="high">
				    <param name="wmode" value="opaque">
				    <param name="swfversion" value="6.0.65.0">
